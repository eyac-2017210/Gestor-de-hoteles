...
api.post('/payReservation', mdAuth.ensureAuth, reserController.payReservation);

api.post('/addRoomToReservation/:id', mdAuth.ensureAuth, reserController.addRoomsToReservation);
api.post('/addEventsToReservation/:id', mdAuth.ensureAuth, reserController.addEventsToReservation);
